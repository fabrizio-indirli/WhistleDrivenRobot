...
\begin{itemize}
	...
	\item The Executer: this is the object that, given a command stored in a string, looks for a function able to execute it and, eventually, runs it;
...
\subsubsection{\textit{SerialConnection} extensions}
